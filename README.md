...
Este projeto foi realizado através de uma aplicação web em ASP.NET Core MVC desenvolvida para o gerenciamento completo de produtos (CRUD), com armazenamento e persistência de dados em tempo real na nuvem utilizando o Azure SQL Database.
